...
public class PendanaFundDetailActivity extends AppCompatActivity {
    ...
    private TextView mTextIDPinjaman, mTextTglPendanaan, mTextFundStatus, mTahapPinjam,
            mTextJatuhTempo, mTextTenor, mTextBesarPinjam, mTextDanaKembali, mTextDanaDiterima;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextDanaKembali = findViewById(R.id.fund_dana_kembali);
        mTextDanaDiterima = findViewById(R.id.fund_dana_diterima);
    ...
    private void loadSetsDataPinjaman() {
        ...
        mFire.document(mDocPath).get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                int diterima = Math.toIntExact(doc.getLong("pinjaman_terbayar_pendana"));
                ...
                mTextDanaKembali.setText(pinjam_kembali);

                //[8]
                String terima_form = formatter.format(diterima);
                mTextDanaDiterima.setText(terima_form);
            }
        });
    }
